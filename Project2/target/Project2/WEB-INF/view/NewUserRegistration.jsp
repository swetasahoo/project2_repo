...
<html lang="en">
<head>
  <title>NewUserRegistration Page</title>
  <meta charset="utf-8">
...
<div class="container">
        <div class="card card-container">
            ...
            <form:form commandName="user" class="form-signin" method="post" action="save">
                <span id="reauth-email" class="reauth-email"></span>
                <form:input type="text" path="Username" class="form-control" placeholder="Enter User ID"/>
                <form:input type="password" path="Password" class="form-control" placeholder="Enter Password"/>
                <form:input type="password" path="Cpassword" class="form-control" placeholder="Confirmed Password"/>
                ...
                <div>
 		      		<a href="${pageContext.request.contextPath}">Sing In</a>
 		    	</div>
            </form:form>
            </div>
  </div>
